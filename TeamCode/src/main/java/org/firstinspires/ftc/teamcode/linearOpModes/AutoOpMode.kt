...
import org.firstinspires.ftc.teamcode.modules.mainControl.autoEndState.AutoEndState
...
class AutoOpMode: LinearOpModeBase() {
    ...
    override fun getCollector(): BaseCollector {
        ...
        collector.addAdditionalModules(arrayOf(/* ся модули для автонома*/ AutoEndState))
